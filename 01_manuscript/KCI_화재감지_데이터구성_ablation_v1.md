...
> 작성 상태: v1.6 (2026-06-24). v1.5에서 표 3 mAP@0.5:0.95 열 추가(11n 0.414, 11s 0.423), 그림 3(혼동행렬 2×2 grid, §5.1 말미)·그림 4(C4 PR 곡선, §5.2 말미) 삽입. 그림 3용 fig_confusion_matrix_comp_dfire.png는 분석세션 생성 대기 중. 수치 SSOT = `G:\EXPERT_KCI_Paper\02_data_ssot\TRAINING_LOG.md` (R8 섹션).
