...
> 작성 상태: v1.13 (2026-06-25). v1.12에서 AIHub R9 수치 반영 — §6.3 C2 데이터셋 의존성 업데이트(일관 val 기준 C2>C1 확인, R2/R3 역전은 평가셋 불일치 산물로 판정). 부록 A-2 R9 행 추가. 수치 SSOT = `G:\EXPERT_KCI_Paper\02_data_ssot\TRAINING_LOG.md` (R8·R9 섹션).
